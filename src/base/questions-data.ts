...
const paidEducationAllowedTypeMap: Map<PaidEducationAllowedType, PaidEducationAllowedDescription> = new Map([
...
const educationSpecialityTypeMap: Map<EducationSpecialityType, EducationSpecialityDescription> = new Map([
  ["ECONOMICS", "Экономика"],
